...
async function handleSitemap(
  ...
  async function onRequestGet({
    ...
    let urls = [
      ...
      '/blog.html',
      '/iletisim.html',
      '/blog/tupe-mide-ameliyati-nedir.html',
      '/blog/tupe-mide-kimler-icin-uygun.html',
      '/blog/tupe-mide-ameliyati-sonrasi.html',
      '/blog/tupe-mide-riskleri.html',
      '/blog/gastrik-bypass-nedir.html',
      '/blog/mide-balonu-nedir.html',
      '/blog/mide-botoksu-nedir.html',
      '/blog/gastrik-bypass-mi-tup-mide-mi.html',
      '/blog/obezite-cerrahisi-rehberi.html',
      '/blog/metabolik-cerrahi-tip2-diyabet.html',
      '/blog/metabolik-cerrahi-kimlere-uygulanir.html',
      '/blog/mide-balonu-mu-tup-mide-mi-hangisi-size-daha-uygun.html',
      '/blog/obezite-cerrahisi-sonrasi-spor-ve-hareket.html',
      '/blog/tup-mide-ameliyati-sonrasi-beslenme-nasil-olmali.html',
      '/saglik-turizmi.html',
      '/en/health-tourism.html',
      '/de/gesundheitstourismus.html',
      '/ar/alsiyaaha-alssihiyya.html',
      '/ru/medturizm.html',
      '/az/saglamliq-turizmi.html',
      '/sq/turizmi-shendetesor.html',
      '/nl/medisch-toerisme.html',
