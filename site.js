...
(() => {
  ...
  Object.assign(RUNTIME_I18N.de, {"press.news1Summary":"Der Gesundheitsbericht der İHA fasst Aussagen von Dr. Erol Vural zur Schlauchmagen-Operation, zu möglichen Vorteilen und Grenzen sowie zur Gewichtskontrolle nach der Operation zusammen.","press.news2Summary":"Der Bericht enthält ein Gespräch mit Dr. Erol Vural über die Adipositaschirurgie, die Patientenauswahl, Eignungskriterien und die Vorbereitung vor der Operation.","press.news3Summary":"Der Bericht gibt Aussagen von Dr. Erol Vural zur metabolischen Chirurgie bei Typ-2-Diabetes wieder. Die Überschrift nennt eine Erfolgsrate von 83 %; diese Zahl wird auf dieser Seite nicht unabhängig bewertet."});
  Object.assign(RUNTIME_I18N.ar, {"press.news1Summary":"يجمع تقرير İHA الصحي تصريحات د. إيرول فورال حول كيفية إجراء تكميم المعدة والفوائد والقيود المحتملة وإدارة الوزن بعد الجراحة.","press.news2Summary":"يتضمن التقرير حواراً مع د. إيرول فورال حول نطاق جراحة السمنة وتقييم المريض ومعايير الملاءمة والتحضير قبل الجراحة.","press.news3Summary":"ينقل التقرير تصريحات د. إيرول فورال حول جراحة الأيض والأساليب الجراحية المرتبطة بالسكري من النوع الثاني. ويذكر العنوان نسبة نجاح قدرها 83%؛ ولا تُقيّم هذه النسبة بشكل مستقل في هذه الصفحة."});
  Object.assign(RUNTIME_I18N.ru, {"press.news1Summary":"В медицинском материале İHA собраны комментарии доктора Эрол Вурал о проведении продольной резекции желудка, возможных преимуществах и ограничениях, а также контроле веса после операции.","press.news2Summary":"В публикации приведено интервью с доктором Эрол Вурал о бариатрической хирургии, оценке пациента, критериях подходящего лечения и подготовке к операции.","press.news3Summary":"В публикации приведены комментарии доктора Эрол Вурал о метаболической хирургии и хирургических подходах при диабете 2 типа. В заголовке указана эффективность 83%; эта цифра на данной странице независимо не оценивается."});
  Object.assign(RUNTIME_I18N.az, {"press.news1Summary":"İHA-nın səhiyyə xəbərində Dr. Erol Vuralın mədə kiçiltmə əməliyyatının aparılması, mümkün üstünlükləri və məhdudiyyətləri, həmçinin əməliyyatdan sonrakı çəki idarəetməsi barədə açıqlamaları təqdim olunur.","press.news2Summary":"Materialda Dr. Erol Vural ilə piylənmə cərrahiyyəsinin əhatəsi, pasiyentin qiymətləndirilməsi, uyğunluq meyarları və əməliyyata hazırlıq barədə sual-cavab yer alır.","press.news3Summary":"Materialda Dr. Erol Vuralın metabolik cərrahiyyə və 2-ci tip diabetlə bağlı cərrahi yanaşmalar haqqında açıqlamaları verilir. Başlıqda 83% uğur göstəricisi qeyd olunur; bu rəqəm bu səhifədə müstəqil şəkildə qiymətləndirilmir."});
  Object.assign(RUNTIME_I18N.sq, {"press.news1Summary":"Raporti shëndetësor i İHA përmbledh deklaratat e Dr. Erol Vural mbi gastrektominë në mëngë, përfitimet dhe kufizimet e mundshme dhe menaxhimin e peshës pas operacionit.","press.news2Summary":"Raporti përfshin një pyetje-përgjigje me Dr. Erol Vural mbi fushën e kirurgjisë bariatrike, vlerësimin e pacientit, kriteret e përshtatshmërisë dhe përgatitjen para operacionit.","press.news3Summary":"Raporti paraqet deklarata të Dr. Erol Vural mbi kirurgjinë metabolike dhe qasjet kirurgjikale për diabetin e tipit 2. Titulli përmend një normë suksesi prej 83%; kjo shifër nuk vlerësohet në mënyrë të pavarur në këtë faqe."});
  Object.assign(RUNTIME_I18N.nl, {"press.news1Summary":"Het gezondheidsbericht van İHA bundelt uitspraken van dr. Erol Vural over de uitvoering van een sleeve-gastrectomie, mogelijke voordelen en beperkingen en gewichtsbeheersing na de operatie.","press.news2Summary":"Het artikel bevat een vraaggesprek met dr. Erol Vural over bariatrische chirurgie, patiëntbeoordeling, geschiktheidscriteria en voorbereiding op de operatie.","press.news3Summary":"Het artikel geeft verklaringen van dr. Erol Vural over metabole chirurgie en chirurgische benaderingen bij diabetes type 2. De kop noemt een succespercentage van 83%; dit cijfer wordt op deze pagina niet onafhankelijk beoordeeld."});
  Object.assign(RUNTIME_I18N.es, {"press.news1Summary":"El reportaje sanitario de İHA recopila declaraciones del Dr. Erol Vural sobre cómo se realiza la gastrectomía en manga, sus posibles ventajas y limitaciones y el control del peso después de la cirugía.","press.news2Summary":"El reportaje incluye una entrevista con el Dr. Erol Vural sobre el alcance de la cirugía bariátrica, la evaluación del paciente, los criterios de elegibilidad y la preparación preoperatoria.","press.news3Summary":"El reportaje recoge declaraciones del Dr. Erol Vural sobre la cirugía metabólica y los enfoques quirúrgicos relacionados con la diabetes tipo 2. El titular menciona una tasa de éxito del 83 %; esta cifra no se evalúa de forma independiente en esta página."});
